...
CREATE TABLE `runways` (
  ...
  CONSTRAINT `runways_ibfk_1` FOREIGN KEY (`airport_code`) REFERENCES `airports` (`airport_code`)
...
INSERT INTO `runways` VALUES ('RWY0','AP0',3000,45,'Available'),('RWY1','AP1',3100,46,'In Use'),('RWY2','AP2',3200,47,'Available'),('RWY3','AP3',3300,48,'In Use'),('RWY4','AP4',3400,49,'Available'),('RWY5','AP5',3500,50,'In Use'),('RWY6','AP6',3600,51,'Available');
